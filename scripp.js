...
function sbakhir(){Bn.style.display="none";setTimeout(stakhir,500);} function stakhir(){tmbl.innerHTML="😶‍🌫️😶‍🌫️😶‍🌫️ send";Tombol.style="margin-top:10px;opacity:1;transform: scale(1)";ftom=5;fungsi=0;}
...
async function diterima(){
    ...
    bq.style = "position:relative;opacity:1;visibility:visible;transform: scale(1);transition:all .3s ease;border-radius:var(--bingkai);margin-top:0;";
    Tombol.style="opacity:0;transition:all .3s ease;transform: scale(.1);";
    otomatis2();
 }
